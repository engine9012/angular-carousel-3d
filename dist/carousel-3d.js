 ...
 * Version: 0.3.0 - 2017-09-05T07:51:58.003Z
 * License: MIT
 */
...
(function () {
    ...
    angular.module('angular-carousel-3d').directive('carousel3dSlide', carousel3dSlide);
...
(function () {
    ...
    angular.module('angular-carousel-3d').controller('Carousel3dController', Carousel3dController);
    ...
    function Carousel3dController($scope, $element, $attrs, $timeout, $interval, $log, $window, Carousel3dService) {
        ...
        function init() {
            Carousel3dService.build(vm.model, vm.options).then(function handleResolve(carousel) {
                ...
                $timeout(function () {
                    ...
                    $wrapper.css({ 'width': '40%', 'height': outerHeight + 'px' });
        ...
        function render(animate, speedTime) {
            ...
            getSlide(carousel3d.currentIndex).addClass('current').css({
                zIndex: zIndex,
                opacity: 1,
                visibility: 'visible',
        ...
        function setCss(i, zIndex, positive) {
            ...
            var leftRemain = carousel3d.space == 'auto' ? parseInt((i + 1) * (carousel3d.width / 1.5)) : parseInt((i + 1) * carousel3d.space), transform,
                // transform = positive ? 'translateX(' + leftRemain + 'px) translateZ(-' + (carousel3d.inverseScaling + (i + 1) * 100) + 'px) rotateY(-' + carousel3d.perspective + 'deg)' : 'translateX(-' + leftRemain + 'px) translateZ(-' + (carousel3d.inverseScaling + (i + 1) * 100) + 'px) rotateY(' + carousel3d.perspective + 'deg)',
                left = '0%',
            ...
            if(window.innerWidth > 400){
                transform = positive ? 'translateX(230px) translateZ(-600px) translateY(-30px)' : 'translateX(-230px) translateZ(-600px) translateY(-30px) rotateY(0deg)';
            }else if(window.innerWidth > 320){
                transform = positive ? 'translateX(210px) translateZ(-600px) translateY(-30px)' : 'translateX(-210px) translateZ(-600px) translateY(-30px) rotateY(0deg)';
            }else{
                transform = positive ? 'translateX(180px) translateZ(-600px)' : 'translateX(-180px) translateZ(-600px) rotateY(0deg)';
            }
        ...
        function goFar(index) {
            if (index === carousel3d.currentIndex) {
                return;
            }

            var visibleSlides = carousel3d.getVisibleSlidesIndex();

            var indexInVisibleSlides = visibleSlides.findIndex(function (val) {
                return val === index;
            });
            if (indexInVisibleSlides < 0) {
                return;
            }
            var currentIndexInVisibleSlides = visibleSlides.findIndex(function (val) {
                return val === carousel3d.currentIndex;
            });
            ...
            var timeBuff = 0;
            var timeout = carousel3d.animationSpeed / diff2;
...
(function () {
    ...
    angular.module('angular-carousel-3d').directive('carousel3d', carousel3d);
    ...
    function carousel3d() {
        ...
        var carousel3d = {
            restrict: 'AE',
            template: '' + '<div class="carousel-3d-container" ng-switch="vm.isLoading" ng-mouseenter="vm.autoRotationLocked=true" ng-mouseleave="vm.autoRotationLocked=false">' +
            '   <div class="carousel-3d-loader" ng-switch-when="true">' + '   </div>' + '   <div ng-switch-when="false" ng-switch="vm.isSuccessful">' + '       <div class="carousel-3d" ng-switch-when="true" ng-show="vm.isRendered" ng-transclude>' + '       </div>' + '       <p ng-switch-when="false" class="carousel-3d-loader-error">There was a problem during load</p>' + '       <div ng-if="vm.controls" class="carousel-3d-controls">' + '           <div class="carousel-3d-next arrow-left" ng-click="vm.options.dir === \'ltr\' ? vm.goNext() : vm.goPrev()"></div>' + '           <div class="carousel-3d-prev arrow-right" ng-click="vm.options.dir === \'ltr\' ? vm.goPrev() : vm.goNext()"></div>' + '       </div>' + '   </div>' + '</div>',
            replace: true,
            scope: {
                model: '=ngModel',
                options: '=',
...
(function () {
    ...
    angular.module('angular-carousel-3d').factory("Carousel3dService", Carousel3dService);
    ...
    function Carousel3dService($rootScope, $q, $log) {
        ...
        function getVisibleSlidesIndex() {
            ...
            var visibleSlidesArr = Object.values(visibleSlidesObj);
            ...
            var indexInTab = visibleSlidesArr.findIndex(function (val) {
                return val === _this.currentIndex;
            });
